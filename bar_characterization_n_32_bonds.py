...
# Prints out the class, length of bars born, number of bars born, and the time of birth
                            ...
                            if j2 != 0:
                                for l in range(0,k-i1-i2+1):
                                    a=((-1)**(l)*math.factorial(n)
                                      ...
                                      *math.factorial(i1)*math.factorial(i2)*math.factorial(j1)*math.factorial(j2+l)))
                                    avals.append(a)
                                print('Class',(n,k,i1,i2,j1,j2), u'\u03B3-\u03B1 bars born: ', (sum(avals)), ' at ', j1, '\u03B1 +'
                                        , j2, '\u03B1 hat +', n-k-j1-j2, '\u03B2 +', k-i1-i2, '\u03B3 +'
                                        , i1, '\u03B4 +', i2, '\u03B4 hat.') #gamma-alpha
                            elif i1+i2==k and j2==0 and j1<n-k:
                                for l in range(0,i1+1):
                                    b=((-1)**(l)*math.factorial(n)
                                      /(math.factorial(n-k-j1-j2+l)*math.factorial(k-i1-i2)
                                      *math.factorial(i1-l)*math.factorial(i2)*math.factorial(j2)*math.factorial(j1)))
                                    bvals.append(b)
                                print('Class',(n,k,i1,i2,j1,j2), u'\u03B4-\u03B2 bars born: ', (sum(bvals)), ' at ', j1, '\u03B1 +'
                                        , j2, '\u03B1 hat +', n-k-j1-j2, '\u03B2 +', k-i1-i2, '\u03B3 +'
                                        , i1, '\u03B4 +', i2, '\u03B4 hat.') #delta-beta
                            elif i1==0 and i2==k and j2==0 and j1==n-k:
                                c=(math.factorial(n)
                                  /(math.factorial(n-k-j1-j2)*math.factorial(k-i1-i2)
                                  *math.factorial(i1)*math.factorial(i2)*math.factorial(j2)*math.factorial(j1)))
                                print('Class',(n,k,i1,i2,j1,j2), 'semi-\u221E bars born: ', c, ' at ', j1, '\u03B1 +'
                                        , j2, '\u03B1 hat +', n-k-j1-j2, '\u03B2 +', k-i1-i2, '\u03B3 +'
                                        , i1, '\u03B4 +', i2, '\u03B4 hat.')
                            else:
